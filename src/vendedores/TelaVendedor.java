...
public class TelaVendedor extends javax.swing.JFrame 
{
    ...
    public TelaVendedor() 
    {
        ...
        gt = new GhostText(campoPesquisaVendedor, "Código ou nome do vendedor");
    ...
    private void initComponents() {
        ...
        tabelaPesqVendedor.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO VENDEDOR", "NOME", "DATA CADASTRO"
            }
        ) {
    ...
    private void btnIncluirVendedorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIncluirVendedorActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(this, "Uma tela do menu de vendedores já está aberta. \nFeche-a para abrir outra!");
        }
    ...
    {
        if (campoPesquisaVendedor.getText().equalsIgnoreCase("Código ou nome do vendedor") || campoPesquisaVendedor.getText().equalsIgnoreCase("")) 
        {
            try
            {
                BancoConexoes.abrirConexao();
                ResultSet resp = BancoVendedor.buscarVendedoresPorNome("");
        ...
        else if (Utilitarios.soNumericos(campoPesquisaVendedor.getText().toUpperCase()) == true)
        {
            ...
            {
                BancoConexoes.abrirConexao();
                ResultSet resp = BancoVendedor.buscarVendedoresCodResult(Integer.parseInt(campoPesquisaVendedor.getText()));
                LtpUtil.loadFormatJTable(jScrollPane2, resp, true);
                BancoConexoes.fecharConexao();
            }
            catch (SQLException | LtpUtilException e)
        ...
        else
        {
            ...
            {
                BancoConexoes.abrirConexao();
                ResultSet resp = BancoVendedor.buscarVendedoresPorNome(campoPesquisaVendedor.getText());
                LtpUtil.loadFormatJTable(jScrollPane2, resp, true);
                BancoConexoes.fecharConexao();
            } 
            catch (SQLException | LtpUtilException e)
